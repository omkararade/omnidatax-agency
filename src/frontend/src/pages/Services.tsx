...
const SERVICE_CATEGORIES: ServiceCategory[] = [
  ...
  },
  {
    ...
    description:
      "Custom web apps, SaaS platforms, and data-driven dashboards engineered end-to-end — from pixel-perfect React frontends to robust backend APIs — built to ship fast and scale without limits.",
    features: [
    ...
    deliverables: [
      ...
      { label: "Backend API & Docs", icon: <Server className="w-4 h-4" /> },
      { label: "CI/CD Pipeline", icon: <Zap className="w-4 h-4" /> },
    ],
    outcomes: [
